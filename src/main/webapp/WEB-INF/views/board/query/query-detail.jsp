	...
	<%@ include file="/WEB-INF/views/common/alertMsg.jsp" %>
		...
		<main>
			...
			<div class="view-area active">
				...
				<div id="help-inContent">${qvo.content}
					...
					<c:forEach items="${qvo.attList}" var="image">
						<img src="${rootContext}/resources/upload/query/${image.changeName}" width="150px" height="150px" />
					</c:forEach>
			...
			<c:if test="${memberLog.name eq qvo.writer }">
				<button id="write_submit_delete" onclick="location.href='${rootContext}/query/delete?num=${queryNo}'">
					<span>삭제하기</span>
				</button>

				<button id="write_submit_edit" onclick="location.href='${rootContext}/query/edit?num=${queryNo}'">
					<span>수정하기</span>
				</button>
			</c:if>
