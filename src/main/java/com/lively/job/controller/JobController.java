...
//	목록 조회
	@GetMapping("list")
	public String getJobList(JobVo vo, @RequestParam(defaultValue = "1") int page , @RequestParam Map<String , String> searchMap,  Model model) {
	
		
		//데이터
		int listCount = js.getCnt(searchMap);
...
//		model.addAttribute("cvoList" , cvoList);
	...
	//작성하기
	@PostMapping("write")
	public String write(JobVo vo , HttpSession session) throws Exception {
		int result = js.write(vo);
	...
	// 수정하기 (작성자 본인만)
		...
		// 삭제하기 (작성자 본인만)
		@GetMapping("delete")
		public String delete(JobVo vo , HttpSession session) throws Exception {
			
//			MemberVo loginMember = (MemberVo) session.getAttribute("loginMember");
//			String writerNo = loginMember.getNo();
//			vo.setWriter(writerNo);
			
			int result = js.delete(vo);
